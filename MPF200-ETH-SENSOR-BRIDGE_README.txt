...
2. Follow the steps from below and the link mentioned in 2.c to setup environment for running tao people net
	...
	b. sh docker/demo.sh <enter>
		b.1: It runs holoscan-sensor-bridge docker container
	c. https://docs.nvidia.com/holoscan/sensor-bridge/2.6.0/examples.html#running-the-tao-peoplenet-example
...
2. Follow the steps from below and the link mentioned in 2.c to setup environment for running tao people net
	...
	b. sh docker/demo.sh <enter>
		b.1: It runs holoscan-sensor-bridge docker container
	c. https://docs.nvidia.com/holoscan/sensor-bridge/2.6.0/examples.html#running-the-body-pose-example
