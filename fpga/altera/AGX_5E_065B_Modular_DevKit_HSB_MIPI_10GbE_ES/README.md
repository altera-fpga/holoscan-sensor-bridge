# Holoscan Sensor Bridge IMX678 MIPI to 10GbE System Example Design for Agilex™ 5 Group B (ES) Devices

## Overview

The Holoscan Sensor Bridge IMX678 MIPI to 10GbE System Example Design for Agilex™ 5  Group B (ES) Devices demonstrates an implementation of using industry-standard Mobile Industry Processor Interface (MIPI) D-PHY and MIPI CSI-2 interface on Agilex™ 5 Group B (ES) FPGAs to integrate to a Holoscan processing flow.

> [!IMPORTANT]
> The Agilex™ 5 Modular Development Kit targeted by this design has been discontinuted per [PDN2513](https://docs.altera.com/v/u/docs/869016/pdn2513-product-discontinuance-of-selected-fpga-development-kit-ordering-codes).
> The design targeting the available Agilex™ 5 Group Modular Development Kit can be found here [AGX_5E_065B_Modular_DevKit_HSB_MIPI_10GbE](../AGX_5E_065B_Modular_DevKit_HSB_MIPI_10GbE)
...
|Board|16|32|0|0|
|Clock|12|60|0|0|
|GTS Ethernet|1020|1451|1|0|
|HSB|26149|78643|38|4|
|MIPI HSB Pipeline|928|2665|14|0|
|MIPI|9911|21912|23|0|
|***Total***|***38036***|***104763***|***76***|***4***|
...
* [Agilex™ 5 FPGA and SoC E-Series Modular Development Kit (ES) - MK-A5E065BB32AES1](https://www.altera.com/products/devkit/po-3001/agilex-5-fpga-and-soc-e-series-modular-development-kit-es)
...
* To program the QSPI flash using JIC:
  ...
  * To use the newly flashed image Power cycle the board, ensuring that the **S4** dip switch on the SOM is set to to **ON-ON**.
