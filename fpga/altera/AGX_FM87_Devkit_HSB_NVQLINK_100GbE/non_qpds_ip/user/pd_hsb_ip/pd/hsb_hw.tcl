...
proc create_ui { } {
  ...
  add_display_item "ID"                             USE_EPOCH_TIME                  parameter
  add_display_item "ID"                             BUILD_REV                       parameter
  add_display_item "ID"                             BUILD_REV_GUI                   parameter
  ...
  add_parameter           USE_EPOCH_TIME        INTEGER               0
  set_parameter_property  USE_EPOCH_TIME        DISPLAY_NAME          "Use Epoch Time for Build Revision"
  set_parameter_property  USE_EPOCH_TIME        DISPLAY_HINT          boolean
  set_parameter_property  USE_EPOCH_TIME        AFFECTS_ELABORATION   true
  ...
  set_parameter_property  BUILD_REV             DERIVED               true
  set_parameter_property  BUILD_REV             VISIBLE               false

  add_parameter           BUILD_REV_GUI         STD_LOGIC_VECTOR      0
  set_parameter_property  BUILD_REV_GUI         DISPLAY_NAME          "Build Revision"
  set_parameter_property  BUILD_REV_GUI         DISPLAY_UNITS         "48-bit"
  set_parameter_property  BUILD_REV_GUI         WIDTH                 48
  set_parameter_property  BUILD_REV_GUI         ALLOWED_RANGES        0:[expr {(1<<48)-1}]
  set_parameter_property  BUILD_REV_GUI         AFFECTS_ELABORATION   false
  set_parameter_property  BUILD_REV_GUI         DERIVED               false
  set_parameter_property  BUILD_REV_GUI         VISIBLE               true
...
proc val_callback { } {
  ...
  set v_timestamp                   [clock seconds]
  set v_timestamp_hex               [format "0x%X" ${v_timestamp}]

  # HSB General parameters
  # Shift by 16 bits as software prints 48:16
  set v_build_rev               ${v_timestamp_hex}0000

  set build_rev_gui [get_parameter_value BUILD_REV_GUI]
  if {[get_parameter_value USE_EPOCH_TIME] > 0} {
    set_parameter_property  BUILD_REV          VISIBLE true
    set_parameter_property  BUILD_REV_GUI      VISIBLE false
    set_parameter_value     BUILD_REV          $v_build_rev
  } else {
    set_parameter_property  BUILD_REV          VISIBLE false
    set_parameter_property  BUILD_REV_GUI      VISIBLE true
    set_parameter_value     BUILD_REV          $build_rev_gui
  }
