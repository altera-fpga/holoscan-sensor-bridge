...
create_clock -period "156.250000 MHz" -name {refclk_eth_fgt}  [get_ports refclk_eth_fgt]
# refclk_eth_fht is unused in 100G-4 (FGT PMA, FHT common PLL disabled) -
# the port is not present at the top level, so no clock is created for it here.
