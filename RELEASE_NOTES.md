...
- **Firmware Setup** `hsb_flasher` as primary
  [firmware setup](https://archive.docs.nvidia.com/holoscan/sensor-bridge/2.6.0/sensor_bridge_firmware_setup.html)
  tool.
...
- **x86 Linux** added
  [RoCE setup support](https://archive.docs.nvidia.com/holoscan/sensor-bridge/2.6.0/setup.html#sd-tab-item-4)
- **Agentic AI** Added
...
- **Thor support with Leopard Eagle VB1940 cameras.** Documentation and device
  ...
  [Thor JP7 setup instructions here](https://archive.docs.nvidia.com/holoscan/sensor-bridge/2.6.0/setup.md).
...
- PTP configuration following boot-up is very touchy and error-prone. If you have
  ...
  [host setup instructions](https://archive.docs.nvidia.com/holoscan/sensor-bridge/2.6.0/setup.html)
  carefully.
